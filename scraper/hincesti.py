"""
Web scraper for hincesti.md website
...
# Base URLs
BASE_URL = "https://hincesti.md"
BASE_LISTING_URL = f"{BASE_URL}/page"

# Output directory
OUTPUT_DIR = Path("data-cleaned/raioane/RepMoldova/Hincesti")
...
def get_article_urls_from_page(page_num: int):
	...
	# Articles on listing pages - look for links with class="td-image-wrap"
	# They are in the format: <a href="https://hincesti.md/2025/12/01/..." class="td-image-wrap">
...
def extract_article_data(url: str):
	"""Extract title and content from a hincesti.md article page."""
	headers = {
		"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36"
	}
	...
	# Title extraction: get from h1 with class "entry-title"
	title = ""
	...
	# Content extraction: look for div with class "td-post-content" or "tagdiv-type"
	...
	if content_container:
		...
		# Remove social share buttons and other unwanted elements
...
def main():
	...
	for idx, url in enumerate(unique_urls):
		...
		filename = f"Hincesti_MD_{success_count:04d}.json"
