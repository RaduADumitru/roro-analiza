...
BASE_URL = "https://stefan-voda.md"
OUTPUT_DIR = Path("data-cleaned/raioane/RepMoldova/Stefan Voda")


def build_page_url(page_num: int) -> str:
    return f"{BASE_URL}/categorie/stiri/page/{page_num}/"
...
def get_article_urls_from_page(page_num: int):
    ...
    # Article links lie under h2 tags with class jupiterx-post-title
    for h2 in soup.find_all("h2", class_="jupiterx-post-title"):
        link = h2.find("a")
...
def extract_article_data(url: str):
    ...
    # Title: h1.jupiterx-main-header-post-title
    title = ""
    h1 = soup.find("h1", class_="jupiterx-main-header-post-title")
    if h1:
    ...
    # Content: div.jupiterx-post-content
    entry = soup.find("div", class_="jupiterx-post-content")
...
def main():
    ...
    for idx, url in enumerate(unique_urls):
        ...
        filename = f"Stefan_Voda_{success_count:04d}.json"
