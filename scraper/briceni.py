"""
Web scraper for briceni.md website
...
BASE_URL = "https://briceni.md"
NUM_PAGES = 48

# Output directory
OUTPUT_DIR = Path("data-cleaned/raioane/RepMoldova/Briceni")
...
def extract_article_data(url):
    """
    Extract title and content from a Briceni article page.
        ...
        if entry_element:
            ...
            for element in entry_element.children:
                if isinstance(element, str):
                    ...
                    if text and not text.startswith('data-') and 'facebook' not in text.lower() and 'twitter' not in text.lower() and 'tweet' not in text.lower():
                        text_parts.append(text)
...
def main():
    ...
    for idx, url in enumerate(unique_urls):
        ...
        if status == 'error':
            ...
            filename = f"Briceni_{success_count:04d}.json"
