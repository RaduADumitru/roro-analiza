"""
Web scraper for raioncimislia.md website
...
BASE_URL = "https://raioncimislia.md"
NUM_PAGES = 186

# Output directory
OUTPUT_DIR = Path("data-cleaned/raioane/RepMoldova/Cimislia")
...
def extract_article_data(url):
    """
    Extract title and content from a Cimișlia article page.
...
def main():
    ...
    for idx, url in enumerate(unique_urls):
        ...
        if status == 'error':
            ...
            filename = f"RaionCimislia_{success_count:04d}.json"
